...
function renderStandings(){
 ...
 if(note)note.innerHTML=`Stand op ${date}.<br>${played?'':'Nog geen competitiewedstrijden gespeeld.<br>'}De volgorde volgt ATC.`;
